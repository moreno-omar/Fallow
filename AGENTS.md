...
## Important reading 
- Read `@SPEC.md`, `@ROADMAP.md`, and `@PLAN.md`.  Implement **Phase number** of the roadmap, following PLAN.md as guide. Check `@TASKS.md` for the current sub-tasks to execute.
